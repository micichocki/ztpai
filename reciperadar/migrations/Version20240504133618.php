 ...
 */
final class Version20240504133618 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE comment (id INT NOT NULL, creator_id INT NOT NULL, content TEXT NOT NULL, PRIMARY KEY(id))');
